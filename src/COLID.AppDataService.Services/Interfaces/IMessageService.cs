...
namespace COLID.AppDataService.Services.Interfaces
{
    ...
    public interface IMessageService : IServiceBase<Message>
    {
        ...
        void DeleteByAdditionalInfo(IList<Uri> distributionEndpoints);

        /// <summary>
        /// 
        /// </summary>
        /// <param name="distributionEndpoints"></param>
        IList<(Uri, DateTime)> GetByAdditionalInfo(IList<Uri> distributionEndpoints);
        ...
        Task SendInvalidContactsMessageToUser(ColidEntryContactInvalidUsersDto cec);
